...
import { Articles } from '../banner/bannerweb';
    ...
    <div className="bg-[#0f172a] py-12 px-4 md:px-8 lg:px-12">
      <div className="max-w-7xl mx-auto">
        <div className="mb-2">
          ...
          <span className="text-sm text-teal-400 font-bold"> WEB </span>
        </div>
        <h1 className="text-3xl font-bold mb-2 text-white">Ini dia yang kamu cari</h1>
        <p className="text-gray-400 text-lg mb-4">Ada 208 artikel dalam kategori Web.</p>
